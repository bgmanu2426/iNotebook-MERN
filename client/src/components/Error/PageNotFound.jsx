        ...
        <>
            <div class="mx-auto w-full max-w-7xl px-2 md:px-4">
                <div class="mx-auto my-12 flex max-w-6xl flex-col px-2 md:my-24 lg:my-32 lg:flex-row lg:items-center">
                    <div>
                        <div>
                            <h1 class="mt-3 text-3xl font-semibold text-gray-800 md:text-3xl">404 Error</h1>
                            <p class="text-sm font-semibold text-black">We can&#x27;t find that page</p>
                            <p class="mt-4 text-gray-700">Sorry, the page you are looking for doesn&#x27;t exist or has been moved.</p>
                            <div class="mt-6 flex items-center gap-x-3">
                                <button type="button" class="inline-flex items-center rounded-md border border-black px-3 py-2 text-sm font-semibold text-black shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">
                        ...
                        <div class="mt-10 space-y-6">
                            <div>
                                <Link to="/" class="hover:underlin inline-flex items-center gap-x-2 text-sm font-semibold text-black">
                                    <span>Home</span>
                                ...
                                <p class="mt-2 text-sm text-gray-500">Add your Notes to Cloud on the go.</p>
                            </div>
                        </div>
                    </div>
